...
web.go was originally written by [Michael Hoisie](http://hoisie.com) and later adapted by [Shivakumar GN] (https://github.com/shivakumargn) to use the excellent gorilla package.
